...
const Page = () => {
  ...
  return (
    <div className='bg-white flex flex-col md:flex-row  justify-around items-center min-h-screen'>
      <div className='flex flex-col max-w-[600px] p-6 '>
        ...
        <button onClick={handleClick} className='md:hidden bg-black flex items-center justify-center w-full  text-white p-2 mt-4'>
