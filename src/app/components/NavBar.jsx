  ...
  return (
    <div>
        <nav className="navbar bg-black h-[10vh] flex justify-between items-center">
            ...
            <Button onClick ={handleClick} className="'border-purple-500 mr-12 rounded-md font-thin bg-transparent border p-2 hover:bg-purple-600 hover:transition-all duration-300 ease-in-out">Login</Button>
        </nav>
    </div>
  )
}
